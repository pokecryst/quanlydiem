...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        tablePageScoList.addMouseListener(new MouseAdapter() {
        	@Override
        	public void mouseClicked(MouseEvent e) {
        		tablePageScoListMouseClicked(e);
        	}
        });
...
//
    ...
    protected void treeValueChanged(TreeSelectionEvent e) {
      ...
      if (classInfo == null) {
          ...
          return ; // Return an empty list if no class is selected
      }else {
         ...
         lblStuCounts.setText(enrollStuDao.countStudentList(classInfo).toString());
	...
	protected void tablePageScoListMouseClicked(MouseEvent e) {
		var classInfo = selectClassInfoByClassName();
    if (classInfo == null) {
    		System.err.println("No class selected or data not found.");
        return ; // Return an empty list if no class is selected
